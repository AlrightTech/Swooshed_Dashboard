          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className=" px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block" style={{height:"150px",  filter:"grayscale(100%)"}} src={Logo} alt="Logo" />
                <img className="dark:hidden" style={{height:"150px"}} src={LogoDark} alt="Logo" />
              </Link>
